...
Due to COVID, we have been meeting online through [Discord](https://discord.com) to
...
**ANSWER**: {{< underline "People's Republic of China" >}} (accept Middle Kingdom;
accept Zhongguo)
...
**ANSWER**: {{< underline "string instruments" >}} (accept chordophones; accept word forms; accept {{< underline zither >}} before mentioned)
...
**ANSWER**: {{< underline "Sherlock Holmes" >}} (accept either name)
...
**ANSWER**: {{< underline "Heracles" >}} (accept {{< underline "Hercules" >}} until "Greek" is read)
...
**ANSWER**: {{< underline "Stranger Things" >}}
...
Instead of Quizlet, we recommend using **Anki**, which is another flashcard app for studying. Anki is used by many medical students in order to study all their topics and the main benefit about Anki is that it uses a learning technique known as **spaced repetition**. If you would like to know more about spaced repetition and how it could improve your studying, [click here](https://collegeinfogeek.com/spaced-repetition-memory-technique/) To import the provided Quizlet decks above into Anki, you can click this [guide](/posts/2021/1/howtoimportquizletdeckstoanki/).
...
{{< linkbookmark title = "TAG Quiz Bowl Team Discord Server" description = "Click this link to join the TAG Quizbowl Discord Server. Here, we hold practices, announce information concerning tournaments, and share study material." src = "https://blog.logomyway.com/wp-content/uploads/2020/12/discord-logo-4.jpg" href = "https://discord.gg/qR7HwQ8fBZ" >}}
